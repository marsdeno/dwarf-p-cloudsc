...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_DRIVER_GPU_SCC_FIELD_ASYNC( &
     ...
     & AUX, FLUX, TENDENCY_TMP, TENDENCY_LOC, BLOCK_BUFFER_SIZE, NQUEUES)
    ...
    INTEGER(KIND=JPIM) :: CHUNK_SIZE            ! block size
...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    ! Allocate NQUEUES*BLOCK_SIZE on device for each field on the device
    CALL AUX%F_PT%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PQ%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PVFA%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PVFL%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PVFI%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PDYNA%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PDYNL%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PDYNI%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PHRSW%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PHRLW%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PVERVEL%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PAP%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PLU%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PSNDE%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PMFU%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PMFD%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PA%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PSUPSAT%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PLCRIT_AER%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PICRIT_AER%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PRE_ICE%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PCCN%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PNICE%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])

    CALL AUX%F_PAPH%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PLSM%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_LDCUM%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_KTYPE%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PCLV%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])

    CALL TENDENCY_TMP%F_T%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_TMP%F_Q%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_TMP%F_A%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_TMP%F_CLD%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])

    CALL AUX%F_PLUDE%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PCOVPTOT%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL AUX%F_PRAINFRAC_TOPRFZ%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])

    CALL FLUX%F_PFSQLF%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFSQIF%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFCQLNG%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFCQNNG%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFSQRF%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFSQSF%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFCQRNG%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFCQSNG%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFSQLTUR%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFSQITUR%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFPLSL%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFPLSN%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFHPSL%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL FLUX%F_PFHPSN%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])

    CALL TENDENCY_LOC%F_T%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_LOC%F_Q%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_LOC%F_A%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    CALL TENDENCY_LOC%F_CLD%CREATE_DEVICE_DATA(BLK_BOUNDS=[1,NQUEUES*BLOCK_SIZE])
    ...
    DO BLOCK_IDX=0, BLOCK_COUNT-1
      ...
      OFFSET = (QUEUE-1)*BLOCK_SIZE
      CHUNK_SIZE = BLK_BOUNDS(2) - BLK_BOUNDS(1) + 1
...
!$acc & async(QUEUE)
      DO IBLLOC=1, CHUNK_SIZE
        IBL= BLOCK_SIZE*BLOCK_IDX+IBLLOC
