...
INTEGER(KIND=JPIM) :: NQUEUES = 5

#if defined(CLOUDSC_GPU_SCC_FIELD) || defined(CLOUDSC_GPU_SCC_FIELD_ASYNC)
...
CALL GET_ENVIRONMENT_VARIABLE('CLOUDSC_ASYNC_NQUEUES', NQUEUES_CHARS)
...
#ifdef CLOUDSC_GPU_SCC_FIELD_ASYNC
print *, 'Executing CLOUDSC-GPU, "SCC-FIELD-ASYNC", NQUEUES', NQUEUES, ", PACKED STORAGE", USE_PACKED,  ", PINNED FIELDS", INIT_PINNED_VALUE
...
CALL CLOUDSC_DRIVER_GPU_SCC_FIELD_ASYNC( &
     ...
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%AUX, GLOBAL_STATE%FLUX, &
     & GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, USE_PACKED, NQUEUES)
#endif
