...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    DO BLOCK_IDX=0, BLOCK_COUNT-1
      ...
      CALL AUX%F_PQ%GET_DEVICE_DATA_FORCE(PQ, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PVFA%GET_DEVICE_DATA_FORCE(PVFA, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PVFL%GET_DEVICE_DATA_FORCE(PVFL, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PVFI%GET_DEVICE_DATA_FORCE(PVFI, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PDYNA%GET_DEVICE_DATA_FORCE(PDYNA, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PDYNL%GET_DEVICE_DATA_FORCE(PDYNL, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PDYNI%GET_DEVICE_DATA_FORCE(PDYNI, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PHRSW%GET_DEVICE_DATA_FORCE(PHRSW, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PHRLW%GET_DEVICE_DATA_FORCE(PHRLW, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PVERVEL%GET_DEVICE_DATA_FORCE(PVERVEL, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PAP%GET_DEVICE_DATA_FORCE(PAP, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PLU%GET_DEVICE_DATA_FORCE(PLU, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PSNDE%GET_DEVICE_DATA_FORCE(PSNDE, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PMFU%GET_DEVICE_DATA_FORCE(PMFU, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PMFD%GET_DEVICE_DATA_FORCE(PMFD, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PA%GET_DEVICE_DATA_FORCE(PA, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PSUPSAT%GET_DEVICE_DATA_FORCE(PSUPSAT, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PLCRIT_AER%GET_DEVICE_DATA_FORCE(PLCRIT_AER, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PICRIT_AER%GET_DEVICE_DATA_FORCE(PICRIT_AER, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PRE_ICE%GET_DEVICE_DATA_FORCE(PRE_ICE, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PCCN%GET_DEVICE_DATA_FORCE(PCCN, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PNICE%GET_DEVICE_DATA_FORCE(PNICE, BLK_BOUNDS=BLK_BOUNDS)
      
      CALL AUX%F_PAPH%GET_DEVICE_DATA_FORCE(PAPH, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PLSM%GET_DEVICE_DATA_FORCE(PLSM, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_LDCUM%GET_DEVICE_DATA_FORCE(LDCUM, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_KTYPE%GET_DEVICE_DATA_FORCE(KTYPE, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PCLV%GET_DEVICE_DATA_FORCE(PCLV, BLK_BOUNDS=BLK_BOUNDS)
      
      CALL TENDENCY_TMP%F_T%GET_DEVICE_DATA_FORCE(TEND_TMP_T, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_TMP%F_Q%GET_DEVICE_DATA_FORCE(TEND_TMP_Q, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_TMP%F_A%GET_DEVICE_DATA_FORCE(TEND_TMP_A, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_TMP%F_CLD%GET_DEVICE_DATA_FORCE(TEND_TMP_CLD, BLK_BOUNDS=BLK_BOUNDS)

      CALL AUX%F_PLUDE%GET_DEVICE_DATA_FORCE(PLUDE, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PCOVPTOT%GET_DEVICE_DATA_FORCE(PCOVPTOT, BLK_BOUNDS=BLK_BOUNDS)
      CALL AUX%F_PRAINFRAC_TOPRFZ%GET_DEVICE_DATA_FORCE(PRAINFRAC_TOPRFZ, BLK_BOUNDS=BLK_BOUNDS)
      
      CALL FLUX%F_PFSQLF%GET_DEVICE_DATA_FORCE(PFSQLF, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQIF%GET_DEVICE_DATA_FORCE(PFSQIF, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQLNG%GET_DEVICE_DATA_FORCE(PFCQLNG, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQNNG%GET_DEVICE_DATA_FORCE(PFCQNNG, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQRF%GET_DEVICE_DATA_FORCE(PFSQRF, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQSF%GET_DEVICE_DATA_FORCE(PFSQSF, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQRNG%GET_DEVICE_DATA_FORCE(PFCQRNG, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQSNG%GET_DEVICE_DATA_FORCE(PFCQSNG, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQLTUR%GET_DEVICE_DATA_FORCE(PFSQLTUR, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQITUR%GET_DEVICE_DATA_FORCE(PFSQITUR, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFPLSL%GET_DEVICE_DATA_FORCE(PFPLSL, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFPLSN%GET_DEVICE_DATA_FORCE(PFPLSN, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFHPSL%GET_DEVICE_DATA_FORCE(PFHPSL, BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFHPSN%GET_DEVICE_DATA_FORCE(PFHPSN, BLK_BOUNDS=BLK_BOUNDS)
      
      CALL TENDENCY_LOC%F_T%GET_DEVICE_DATA_FORCE(TEND_LOC_T, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_Q%GET_DEVICE_DATA_FORCE(TEND_LOC_Q, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_A%GET_DEVICE_DATA_FORCE(TEND_LOC_A, BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_CLD%GET_DEVICE_DATA_FORCE(TEND_LOC_CLD, BLK_BOUNDS=BLK_BOUNDS)
...
!$acc end data
      ...
      IF(USE_PACKED)THEN
         CALL FLUX%DATA_WRONLY%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
         CALL TENDENCY_LOC%FIELD_GANG%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
         ! If this is called then the subsequent ...%F_PTR%SYNC_HOST_FORCE() calls
      ...
      CALL AUX%F_PRAINFRAC_TOPRFZ%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQLF%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQIF%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQLNG%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQNNG%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQRF%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQSF%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQRNG%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFCQSNG%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQLTUR%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFSQITUR%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFPLSL%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFPLSN%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFHPSL%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL FLUX%F_PFHPSN%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_T%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_Q%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_A%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
      CALL TENDENCY_LOC%F_CLD%SYNC_HOST_FORCE(BLK_BOUNDS=BLK_BOUNDS)
