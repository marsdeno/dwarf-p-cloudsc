...
MODULE CLOUDSC_DRIVER_GPU_SCCC_MOD
  ...
  USE CLOUDSC_GPU_SCC_C_MOD, ONLY: CLOUDSC_SCC_C
...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_DRIVER_GPU_SCCC( &
...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    CALL CLOUDSC_SCC_C<<<GRIDDIM,BLOCKDIM , (nproma+1)*(25*8*3+1)>>> &
  ...
  END SUBROUTINE CLOUDSC_DRIVER_GPU_SCCC

END MODULE CLOUDSC_DRIVER_GPU_SCCC_MOD
